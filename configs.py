...
class Config(object):
	API_ID = int(os.environ.get("API_ID", "29798427"))
	API_HASH = os.environ.get("API_HASH", "b273dd0246a0e0b369c4266a3e6deb2e")
	BOT_TOKEN = os.environ.get("BOT_TOKEN", "6811058101:AAGbjbpNpLM00Mkws14qyMt26i3uxQ6S8Cg")
	BOT_USERNAME = os.environ.get("BOT_USERNAME", "Mini_netflix_filestore_bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1002068937373"))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "1395730131"))
	DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://Kaif2001:Kaif2001@cluster0.bbnjgsn.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002116670104")
...
│
├🔸👨‍💻 **Developer:** [@Filmymod7](https://t.me/Filmymod7) 
│
├🔹👥 **Bot Support:** [𝐒𝐮𝐩𝐩𝐨𝐫𝐭](https://t.me/Filmymod_Support)
│
├🔸🔔 **Bot Updates:** [𝐔𝐩𝐝𝐚𝐭𝐞𝐬](https://t.me/Filmymod123)
│
╰──────[ 😎 ]───────────⍟
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 **𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿:** [@Filmymod7](https://t.me/Filmymod7) 
...
[**Donate Me**](https://www.paypal.me/Filmymod) (𝐏𝐚𝐲𝐏𝐚𝐥)
"""
	HOME_TEXT = """
**Hᴇʟʟᴏ, [{}](tg://user?id={})
